            ...
            <div className="bg-[hsl(var(--ide-sidebar))] border border-[hsl(var(--ide-border))] rounded-lg shadow-xl overflow-hidden">
                <header className="p-6 border-b border-[hsl(var(--ide-border))]">
                    <h1 className="text-2xl font-bold text-white flex items-center gap-3">
                        <Code2 className="text-blue-500" /> Add New Project
                    </h1>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            required
                            className="w-full bg-black/30 border border-gray-700 rounded-lg p-4 text-white focus:outline-none focus:border-blue-500 transition-colors min-h-[120px]"
